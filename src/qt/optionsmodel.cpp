...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/jurassiccoin/tx/%s|https://coinplorer.com/NVC/Transactions/%s|https://explorer.jurassicco.in/tx/%s|https://bchain.info/NVC/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/jurassiccoin/tx/%s|https://coinplorer.com/NVC/Transactions/%s|https://explorer.jurassicco.in/tx/%s|https://bchain.info/NVC/tx/%s").toString();
