...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about JurassicCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for JurassicCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Jurassiccoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Jurassiccoin addresses"));
...
{
    QString strTitle = tr("JurassicCoin") + " - ";
