...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("JurassicCoins"));
    case mBTC: return QString(QObject::tr("Milli-JurassicCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-JurassicCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
